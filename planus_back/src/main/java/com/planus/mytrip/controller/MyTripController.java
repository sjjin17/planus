...
public class MyTripController {
    ...
    @GetMapping("/made")
    public ResponseEntity<MyTripListResDTO> getMadeTripList(@RequestHeader(name="token") String token, @PageableDefault(sort = "isbn", direction = Sort.Direction.DESC) Pageable pageable) {
